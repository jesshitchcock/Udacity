...
# QUERY LISTS
# create tables in order that allows for foreign key setup. Start with tables that do not have foreign keys. Create subsequent tables once the foreign key reference table exists. 
